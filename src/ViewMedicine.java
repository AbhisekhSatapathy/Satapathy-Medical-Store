...
public class ViewMedicine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 6, 358, -1));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 70, 838, 10));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(792, 16, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Medicine ID", "Name", "Company Name", "Quantity", "Price", "Manufacturing Date", "Expiry Date"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 86, 838, 349));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Click on row to delete medicine");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 453, 242, -1));
        ...
        try{
            ...
            while(rs.next()){
                ...
                model.addRow(new Object[]{
                    rs.getString("medicine_pk"),rs.getString("id"),
                    rs.getString("name"),rs.getString("companyName"),
                    rs.getString("quantity"),rs.getString("price"),
                    formatedMfd,formatedExp
                });
            }
        }catch (Exception e) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(a==0){
            try{
                ...
                ps.setString(1,id);
                ps.executeUpdate();
                JOptionPane.showMessageDialog(null,"Medicine delete sucessfully");
                setVisible(false);
