    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            ...
            while (rs.next()) {
                ...
                java.util.Date dateBillDate = dFormat.parse(billDate);
                String formatedBillDate = dFormat.format(dateBillDate);
                model.addRow(new Object[]{
                    rs.getString("billId"), formatedBillDate,
                    rs.getString("totalPaid"), rs.getString("generatedBy")
                });
            }
        } catch (Exception e) {
